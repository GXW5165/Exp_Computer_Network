...
static void tcp_timer_system_init_once(void)
{
	init_list_head(&timer_list);
	pthread_mutex_init(&timer_list_lock, NULL);
}

static inline void tcp_ensure_timer_system(void)
{
	pthread_once(&timer_once, tcp_timer_system_init_once);
}

static void tcp_abort_sock(struct tcp_sock *tsk)
{
